...
const patientsUrl = "http://localhost:4001/patients";
...
const header = ["Patient ID & Name", "Number", "Last visit", "Status"];
...
export default function Patients() {
  ...
  let ranges = 1;
  patients.length % other["pagination-range"] == 0
    ? (ranges = patients.length / other["pagination-range"])
    : (ranges = patients.length / other["pagination-range"] + 1);

  useEffect(() => {
    getAxios(patientsUrl).then((res) => {
        ...
        <div className="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
            ...
            <form id="table-search" className="max-w-md mx-3">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  const rowFilter = searchInString(patients, valueToSearch);
                  setpatients(rowFilter);
                }}
              >
          ...
          <div className="flex flex-col px-4 py-3 space-y-3 lg:flex-row lg:items-center lg:justify-between lg:space-y-0 lg:space-x-4">
            <div className="flex items-center flex-1 space-x-4">
              <h5>
                <span className="text-gray-500">{"All patients: "}</span>
                <span className="dark:text-white">{patients.length} </span>
              </h5>
            </div>
            <div className="flex flex-col flex-shrink-0 space-y-3 md:flex-row md:items-center lg:justify-end md:space-y-0 md:space-x-3">
              <button
                ...
                onClick={() => setopenModalAddpatient(!openModalAddpatient)}
              >
                <svg
                  ...
                  {header.map((head) => (
                    <th scope="col" className="px-6 py-3" key={head}>
                      <div
                        ...
                        onClick={() => {
                          setpatients(orderElement(patients, ""));
                        }}
                      >
                        {head}
                        <button
                      ...
                      >
                          ...
                          <div className="flex items-center">
                            <button
                              onClick={() => {
                                ...
                                patchAxios(patientsUrl + `/${patient.id}`, {
                                  name: value,
                                }).then((res) => {
                                  setpatients(
                                    patients.filter((e) => {
                        ...
                        >
                          ...
                          <div className="w-[300px] h-[70px] text-wrap truncate flex align-middle items-center">
                            <input
                              type="text"
                              defaultValue={patient["full name"]}
                              className="border-0"
                              ref={inputNameRef}
                            />
                          </div>
              ...
              <ul className="inline-flex items-stretch -space-x-px">
                ...
                <li>
                  <button
                    ...
                    onClick={() => {
                      let val = indexPagination + other["pagination-range"];
                      if (val <= patients.length) setindexPagination(val);
                    }}
                  >
            ...
            <form method="post">
              <div id="data" className="flex flex-col gap-3">
                ...
                <div className="max-w-md">
                  <div className="mb-2 block">
                    <Label htmlFor="file" value="patient photo" />
                  </div>
                  <FileInput
                    id="imagefileUpload"
                    name="img-url"
              ...
              >
                <Button
                  ...
                  type="submit"
                  // onClick={() => setopenModalAddpatient(false)}
                >
                  Add this patient
                </Button>
                <Button
